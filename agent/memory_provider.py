...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - gabru_home (str): The active GABRU_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.gabru``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "gabru").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'gabru memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], gabru_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'gabru memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``gabru_home`` is the active GABRU_HOME directory path.
