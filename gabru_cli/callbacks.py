...
into prompt_toolkit's event loop. Each function takes the GabruCLI instance
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.gabru/.env and never exposed to the model.
    """
