...
def _isolate(tmp_path, monkeypatch):
    """Redirect GABRU_HOME and clear module caches."""
...
def _write_config(tmp_path, config_dict):
    """Write a config.yaml to the test GABRU_HOME."""
    import yaml
...
class TestResolveProviderClientModelNormalization:
    ...
    def test_matching_native_prefix_is_stripped_for_main_provider(self, tmp_path):
        ...
        with (
            patch("gabru_cli.auth.resolve_api_key_provider_credentials", return_value={
                "api_key": "glm-key",
