...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("gabru_cli.config.get_config_path", return_value=config_path), \
             patch("gabru_cli.config.ensure_gabru_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("gabru_cli.config.get_env_path", return_value=env_path), \
             patch("gabru_cli.config.ensure_gabru_home"):
    ...
    def test_ensure_gabru_home_sets_0700(self):
        home = Path(self.tmpdir) / ".gabru"
        with patch("gabru_cli.config.get_gabru_home", return_value=home):
