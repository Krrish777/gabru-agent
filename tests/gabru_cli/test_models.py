"""Tests for the gabru_cli models module."""
...
import gabru_cli.models as _models_mod
...
class TestModelIds:
    def test_returns_non_empty_list(self):
        with patch("gabru_cli.models.fetch_openrouter_models", return_value=LIVE_OPENROUTER_MODELS):
            ids = model_ids()
...
class TestFetchOpenRouterModels:
    ...
    def test_falls_back_to_static_snapshot_on_fetch_failure(self, monkeypatch):
        monkeypatch.setattr(_models_mod, "_openrouter_catalog_cache", None)
        with patch("gabru_cli.models.urllib.request.urlopen", side_effect=OSError("boom")):
            models = fetch_openrouter_models(force_refresh=True)
    ...
    def test_filters_out_models_without_tool_support(self, monkeypatch):
        ...
        gabru-agent is tool-calling-first — surfacing a non-tool model leads to
...
class TestOpenRouterToolSupportHelper:
    ...
    def test_tools_in_supported_parameters(self):
        from gabru_cli.models import _openrouter_model_supports_tools
...
class TestFindOpenrouterSlug:
    def test_exact_match(self):
        from gabru_cli.models import _find_openrouter_slug
        with patch("gabru_cli.models.fetch_openrouter_models", return_value=LIVE_OPENROUTER_MODELS):
...
class TestCheckNousFreeTierCache:
    ...
    @patch("gabru_cli.models.fetch_nous_account_tier")
    @patch("gabru_cli.models.is_nous_free_tier", return_value=True)
    def test_result_is_cached(self, mock_is_free, mock_fetch):
        ...
        with patch("gabru_cli.auth.get_provider_auth_state", return_value={"access_token": "tok"}), \
             patch("gabru_cli.auth.resolve_nous_runtime_credentials"):
    ...
    @patch("gabru_cli.models.fetch_nous_account_tier")
    @patch("gabru_cli.models.is_nous_free_tier", return_value=False)
