"""Tests for the interactive session browser (`gabru sessions browse`).
...
from gabru_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """gabru sessions browse should be parseable."""
        from gabru_cli.main import main as _main_entry
