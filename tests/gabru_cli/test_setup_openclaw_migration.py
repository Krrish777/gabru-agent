...
class TestOfferOpenclawMigration:
    ...
    def test_skips_when_no_openclaw_dir(self, tmp_path):
        ...
        with patch("gabru_cli.setup.Path.home", return_value=tmp_path):
            assert setup_mod._offer_openclaw_migration(tmp_path / ".gabru") is False
    ...
    def test_skips_when_migration_script_missing(self, tmp_path):
        ...
        openclaw_dir.mkdir()
        with (
            patch("gabru_cli.setup.Path.home", return_value=tmp_path),
    ...
    def test_skips_when_user_declines(self, tmp_path):
        ...
        openclaw_dir = tmp_path / ".openclaw"
        openclaw_dir.mkdir()
        script = tmp_path / "openclaw_to_gabru.py"
    ...
    def test_runs_migration_when_user_accepts(self, tmp_path):
        ...
        # Create a fake gabru home with config
        ...
        fake_mod = ModuleType("openclaw_to_gabru")
        ...
        fake_migrator.migrate.return_value = {
            ...
            "output_dir": str(gabru_home / "migration"),
        }
        ...
        with (
            ...
            result = setup_mod._offer_openclaw_migration(gabru_home)
    ...
    def test_creates_config_if_missing(self, tmp_path):
        ...
        with (
            ...
            setup_mod._offer_openclaw_migration(gabru_home)
