...
def reset_skin_state():
    ...
    from gabru_cli import skin_engine
...
class TestSkinConfig:
    ...
    def test_get_branding_with_fallback(self):
        from gabru_cli.skin_engine import load_skin
        skin = load_skin("default")
        assert skin.get_branding("agent_name") == "Gabru Agent"
...
class TestBuiltinSkins:
    ...
    def test_all_builtin_skins_have_complete_colors(self):
        from gabru_cli.skin_engine import _BUILTIN_SKINS, _build_skin_config
...
class TestSkinManagement:
    ...
    def test_get_active_skin_defaults(self):
        from gabru_cli.skin_engine import get_active_skin
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        # Patch skins dir
        monkeypatch.setattr("gabru_cli.skin_engine._skins_dir", lambda: skins_dir)
...
class TestCliBrandingHelpers:
    def test_active_prompt_symbol_default(self):
        from gabru_cli.skin_engine import get_active_prompt_symbol
