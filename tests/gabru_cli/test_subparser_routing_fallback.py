...
The main() function in gabru_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `gabru -c model`
...
def _build_parser():
    """Build a minimal replica of the gabru top-level parser."""
