"""Tests for gabru_cli/tips.py — random tip display at session start."""

import pytest
from gabru_cli.tips import TIPS, get_random_tip
...
class TestTipIntegrationInCLI:
    ...
    def test_tip_import_works(self):
        ...
        from gabru_cli.tips import get_random_tip
