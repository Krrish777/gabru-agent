...
class TestXiaomiAliases:
    ...
    def test_normalize_provider_models_py(self):
        from gabru_cli.models import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"

    def test_normalize_provider_providers_py(self):
        from gabru_cli.providers import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"
...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from gabru_cli.model_normalize import _VENDOR_PREFIXES
    ...
    def test_matching_prefix_strip(self):
        ...
        from gabru_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in GABRU_OVERLAYS
        overlay = GABRU_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify gabru doctor recognizes Xiaomi env vars."""

    def test_provider_env_hints(self):
        from gabru_cli.doctor import _PROVIDER_ENV_HINTS
...
class TestXiaomiAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from gabru_cli.providers import GABRU_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = GABRU_OVERLAYS["xiaomi"]
