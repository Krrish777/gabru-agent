"""Integration tests for GabruAgentLoop with a local vLLM server.
...
try:
    from environments.agent_loop import AgentResult, GabruAgentLoop
except ImportError:
...
def _make_server_manager():
    ...
    sm = ServerManager([config], tool_parser="gabru")
