...
def _reload_constants():
    """Reload gabru_constants to get a fresh apply_ipv4_preference."""
    import gabru_constants
    importlib.reload(gabru_constants)
    return gabru_constants
...
class TestApplyIPv4Preference:
    ...
    def test_noop_when_force_false(self):
        ...
        from gabru_constants import apply_ipv4_preference
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_gabru_ipv4_patched", False) is True
