...
See: https://github.com/gabru-agent/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for gabru_constants.get_subprocess_home()."""

    def test_returns_none_when_gabru_home_unset(self, monkeypatch):
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("GABRU_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("GABRU_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_injects_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(gabru_home / "home")
    ...
    def test_no_injection_when_gabru_home_unset(self, monkeypatch):
        monkeypatch.delenv("GABRU_HOME", raising=False)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from gabru_cli.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from gabru_cli.profiles import create_profile
