...
def _enable_managed_nous_tools(monkeypatch):
    ...
    gabru_cli.auth and gabru_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("gabru_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("gabru_cli.models.check_nous_free_tier", lambda: False)
