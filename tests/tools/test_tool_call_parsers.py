...
class TestParserRegistry:
    ...
    def test_gabru_parser_registered(self):
        parsers = list_parsers()
        assert "gabru" in parsers
...
class TestGabruParser:
    @pytest.fixture
    def parser(self):
        return get_parser("gabru")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["gabru"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use gabru format since that's universal
