...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_gabru_home_override(self, tmp_path):
        """Auth lookup should read from GABRU_HOME/auth.json, not ~/.gabru/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".gabru").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``gabru tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
