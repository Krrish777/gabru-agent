...
CHECKPOINT_PATH = get_gabru_home() / "processes.json"
...
class ProcessRegistry:
    ...
    def spawn_via_env(
        ...
        log_path = f"{temp_dir}/gabru_bg_{session.id}.log"
        pid_path = f"{temp_dir}/gabru_bg_{session.id}.pid"
        exit_path = f"{temp_dir}/gabru_bg_{session.id}.exit"
