...
# GABRU_SESSION_SOURCE=tool so they don't clutter the user's session history.
...
def session_search(
    ...
    try:
        ...
        summaries = []
        for (session_id, match_info, conversation_text, _), result in zip(tasks, results, strict=False):
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from gabru_state import DEFAULT_DB_PATH
