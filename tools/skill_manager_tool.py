...
~/.gabru/skills/. Existing skills (bundled, hub-installed, or user-created)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.gabru/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        f"New skills go to {display_gabru_home()}/skills/; existing skills can be modified wherever they live.\n\n"
