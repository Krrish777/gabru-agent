...
Trust levels:
  - builtin:   Ships with Gabru. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.gabru/\.env|\~/\.gabru/\.env',
     "gabru_env_access", "critical", "exfiltration",
     "directly references Gabru secrets file"),
    ...
    (r'\.gabru/config\.yaml|\.gabru/SOUL\.md',
     "gabru_config_mod", "critical", "persistence",
     "references Gabru configuration files directly"),
