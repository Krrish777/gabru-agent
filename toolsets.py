...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Gabru toolsets (CLI + messaging platforms)
    #
    ...
    "gabru-email": {
        "description": "Email bot toolset - interact with Gabru via email (IMAP/SMTP)",
        "tools": _GABRU_CORE_TOOLS,
        "includes": []
    },
    ...
    "gabru-sms": {
        "description": "SMS bot toolset - interact with Gabru via SMS (Twilio)",
        "tools": _GABRU_CORE_TOOLS,
        "includes": []
    },
    ...
    "gabru-gateway": {
        ...
        "tools": [],
        "includes": ["gabru-telegram", "gabru-discord", "gabru-whatsapp", "gabru-slack", "gabru-signal", "gabru-bluebubbles", "gabru-homeassistant", "gabru-email", "gabru-sms", "gabru-mattermost", "gabru-matrix", "gabru-dingtalk", "gabru-feishu", "gabru-wecom", "gabru-wecom-callback", "gabru-weixin", "gabru-qqbot", "gabru-webhook"]
    }
}
